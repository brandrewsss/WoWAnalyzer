  ...
  statistic() {
    return (
      <Statistic
        ...
        size="flexible"
        tooltip="You should aim to get this as close to 0 as possible. It is almost always a DPS loss to cast Howling Blast without Rime. It is okay to hardcast to apply Frost Fever to a new target, or during movement when you would otherwise cap Runes. The analyzer does not count it against you when you do this"
      >
